...
public class HeritageView: UIView {
    ...
    private func setupElements() {
        ...
        self.titleLabel.center = CGPoint(x: self.center.x, y: self.center.y)
        ...
        self.tempButton.center = CGPoint(x: self.center.x, y: self.titleLabel.frame.maxY + self.tempButton.frame.height/2 + 64)
